...
// Modern button:
// - default: brand-gradient + soft brand-tinted shadow + tiny lift on hover
// - outline / secondary / ghost / destructive / link: tightened states
    ...
    variants: {
      variant: {
        default: cn(
          ...
          // Brand-blue gradient + brand-tinted shadow that grows on hover
          "bg-[linear-gradient(135deg,var(--brand)_0%,color-mix(in_oklab,var(--brand)_75%,white)_100%)]",
          "shadow-[0_2px_8px_-2px_color-mix(in_oklab,var(--brand)_50%,transparent)]",
          "hover:shadow-[0_6px_18px_-4px_color-mix(in_oklab,var(--brand)_60%,transparent)]",
          "hover:brightness-105 hover:-translate-y-px",
        ),
        outline: cn(
          "bg-card/40 border-border/70 text-foreground backdrop-blur-sm",
